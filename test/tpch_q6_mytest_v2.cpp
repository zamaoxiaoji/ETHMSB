    ...
    std::vector<uint64_t> ship_data, TFHESecretKey &sk, double &filter_time)
{
    ...
    pred_nums_cipher = TFHEpp::tlweSymInt32Encrypt<Lvl1>(pred_nums, Lvl1::α, pow(2., 29), sk.key.get<Lvl1>());
    ////////////////////////////////////////////////////////
    ...
    for (size_t i = 0; i < rows; i++)
    {
        ...
        my_greater_than<Lvl1>(discount_ciphers[i], pred_cipher3, pred_cres3[i], discount_bits, ek, ARITHMETIC, 2);
        //pred_cres3[i][Lvl1 :: n] += (1U << 29);
        ...
        my_greater_than<Lvl1>(discount_ciphers[i], pred_cipher4, pred_cres4[i], discount_bits, ek, ARITHMETIC, 2);
        //pred_cres4[i][Lvl1 :: n] += (1U << 29);
        ...
        my_less_than<Lvl1>(quanlity_ciphers[i], pred_cipher5, pred_cres5[i], quantity_bits, ek, ARITHMETIC, 2);
        ...
        // }
        // TFHEpp::tlweSymInt32Decrypt_print<Lvl1>(sub_tlwe, pow(2., 29), sk.key.get<Lvl1>());
